package com.sos_assistance.ecommerce.app.handlers;
...
import com.sos_assistance.ecommerce.common.ex.EntityAlreadyExistException;
import com.sos_assistance.ecommerce.common.ex.UnauthorisedException;
...
import static com.sos_assistance.ecommerce.app.handlers.ErrorResponseHandlerMapper.buildResponseEntity;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(SosAssistanceException.class)
    protected ResponseEntity<Object> handleSsoAssistanceException(@NonNull SosAssistanceException ex) {
        log.error("RestExceptionHandler::handleSsoAssistanceException --Error: [{}]", ex.getMessage());
